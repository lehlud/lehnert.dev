...
<body>
    <a href="/blog/<?= $blog->id ?>/transcript.html" style="position: absolute; top: 0; left: 0; font-size: 0.7rem; padding: 3px; z-index: 99;">
        Transcript
    </a>
    ...
    <footer>
        <div class="send-comment">
            <a href="mailto:blog@lehnert.dev">
                <img src="/_assets/blog/send-comment<?= $rand_send_comment ?>.webp"
